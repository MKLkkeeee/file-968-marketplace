                  ...
                  >
                    <Card className="card-elegant group h-full cursor-pointer overflow-hidden p-0">
                      <div className="relative aspect-square overflow-hidden bg-white/[0.02]">
                        ...
                        {p.isHot && (
                          <div className="absolute left-2 top-2 select-none rounded-full bg-gradient-to-r from-red-500 to-orange-500 px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-white shadow-lg shadow-red-500/40 animate-pulse">
                            🔥 HOT
                          </div>
                        )}
                      </div>
